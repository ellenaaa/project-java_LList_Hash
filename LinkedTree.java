...
public class LinkedTree {
    ...
    public void insert(int key, Object data) {
        ...
        newNode.parent = parent;   //changing parent
    ...
    private void deleteNode(Node toDelete, Node parent) {
        if (toDelete.left != null && toDelete.right != null) {
            ...
            if (toDelete == root) {
                ...
                toDeleteChild.parent = parent; //changing parent
            } else {
    ...
    /* Returns a inorder iterator for this tree. */
    ...
    private class InorderIterator implements LinkedTreeIterator{
        private Node nextNode;
        /* 
         * constructor for a Inorder Iterator
         */ 
        private InorderIterator() {
            // The traversal starts with the root node.
            nextNode = root;
            if(nextNode != null){ //not an empty tree
        ...
        /* 
         * hasNext - check to see if it has next node.
         */ 
        public boolean hasNext(){
            return nextNode != null;
        }
        ...
        public int next(){
            ...
            if (nextNode.right != null) {
                ...
                while(nextNode!=null){
                    ...
                    if(nextNode.parent.left == nextNode){ //finished the left branch 
